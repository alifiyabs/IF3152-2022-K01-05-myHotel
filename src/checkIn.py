...
def BookingCheckIn(window):
    ...
    Button(screenBooking, text = "Cek Kamar" ,font = ("Helvetica", 15, "bold"), bg="#90EE90", width = 15, height = 2, command = verifikasiBookingCheckIn).place(x = 670, y = 430)
...
def checkInWalkIn(window):
    ...
    Button(screenWalkIn, text = "Cek Kamar" ,font = ("Helvetica", 15, "bold"), bg= "#90EE90", width = 15, height = 2, command = verifikasiCheckInWalkIn).place(x = 670, y = 300)
    # Button kembali ke menu utama Check In
...
def verifikasiBookingCheckIn():
    ...
    try:
        ...
        if (row == None):
            ...
            showCheckInBookingValid(screenBooking)
    except mysql.connector.Error as e:
...
def isiDataPengunjung(screenWalkIn):
    ...
    def backToHomeCheckIn():
        homeCheckIn(screenFillData)
    def bukaShowWalkIn():
        showCheckInWalkInValid(screenFillData)
    ...
    Button(screenFillData, text = "Berikutnya", font = ("Helvetica", 15, "bold"), bg="#71BC68", width = 10, height = 1, command = prosesCheckInWalk).place(x = 200, y = 200)
...
def showCheckInBookingValid(screenBooking):
    ...
    # Section Title
    showSectionTitle(screenBookValid)
    def ulangiCheckIn():
        homeCheckIn(screenBookValid)
    ...
    Button(screenBookValid, text = "Berikutnya", font = ("Helvetica", 12, "bold"), bg="#DECBB7", width = 10, height = 1, command = konfirmasiCheckIn1).place(x = 785, y = 400,anchor="ne")
...
def showCheckInWalkInValid(screenFillData):
    ...
    # Section Title
    showSectionTitle(screenWalkInValid)

    def ulangiCheckIn():
        homeCheckIn(screenWalkInValid)
    # Section Title
    ...
    validateCheckInWalkIn()
     ...
     # Button next menuju konfirmasi check in
    Button(screenWalkInValid, text = "Berikutnya", font = ("Helvetica", 12, "bold"), bg="#DECBB7", width = 10, height = 1, command = konfirmasiCheckIn1).place(x = 785, y = 400,anchor="ne")
...
def konfirmasiCheckIn1(screenBookValid):
    ...
    showTitle(screenKonfirmasi1)
    showSectionTitle(screenKonfirmasi1)

    def backToShowBook():
        showCheckInBookingValid(screenKonfirmasi1)

    Label(screenKonfirmasi1, text = "Lanjutkan Check In?", font = ("Helvetica", 12, "bold"), bg= "#FAF0E6").place(x = 635, y = 220,anchor="center")

    # Button
    Button(screenKonfirmasi1, text = "Ya", font = ("Helvetica", 12, "bold"), bg= "#90EE90", width=10, height=1, command=prosesCheckInBook).place(x = 785, y = 320, anchor="se")
...
def konfirmasiCheckIn2(screenWalkInValid):
    ...
    showTitle(screenKonfirmasi2)
    showSectionTitle(screenKonfirmasi2)

    def backToShowBook():
        showCheckInWalkInValid(screenKonfirmasi2)

    Label(screenKonfirmasi2, text = "Lanjutkan Check In?", font = ("Helvetica", 12, "bold"), bg= "#FAF0E6").place(x = 635, y = 220,anchor="center")

    # Button
    Button(screenKonfirmasi2, text = "Ya", font = ("Helvetica", 12, "bold"), bg= "#90EE90", width=10, height=1, command=prosesCheckInBook).place(x = 785, y = 320, anchor="se")
...
def prosesCheckInBook():
    ...
    conn.commit()
    checkInBookingBerhasil(screenBookBerhasil)

def prosesCheckInWalk():
    # Koneksi ke database
    try:
        conn = mysql.connector.connect (
            user = 'root',
    ...
    conn.commit()
    showCheckInWalkInValid(screenWalkInValid)

def checkInBookingBerhasil(screenBookValid):
    ...
    showTitle(screenBookBerhasil)
    showSectionTitle(screenBookBerhasil)

    def ulangCheckInBook():
        BookingCheckIn(screenBookValid)
    
    def backToHomescreen():
        from home import homescreen
        homescreen(screenBookValid)
...
def checkInWalkInBerhasil(screenWalkInValid):
    ...
    showTitle(screenWalkInBerhasil)
    showSectionTitle(screenWalkInBerhasil)

    def ulangCheckInWalk():
        BookingCheckIn(screenWalkInBerhasil)
    
    def backToHomescreen():
        from home import homescreen
        homescreen(screenWalkInBerhasil)

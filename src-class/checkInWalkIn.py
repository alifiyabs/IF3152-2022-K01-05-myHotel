...
class CheckInWalkIn():
    ...
    def isiDataPengunjung(self, screenWalkIn):
        ...
        Label(screenFillData, text = "Pengisian data pengunjung", font = ("Helvetica", 15, "bold"), bg="white").place(x = 635, y = 90, anchor="center")
        ...
        def backToHomeCheckIn():
            from checkIn import CheckIn
            CheckIn().homeCheckIn(screenFillData)

        def bukaKonfirmasiCheckIn2():
            self.konfirmasiCheckIn2(screenFillData)

        # Entry box NIK
        Label(screenFillData, text = "NIK Pelanggan", font = ("Helvetica", 15, "bold"), bg="white").place(x = 485, y = 160)
        ...
        Label(screenFillData, text = "Nama Pelanggan", font = ("Helvetica", 15, "bold"), bg="white").place(x = 485, y = 220)
        ...
        Label(screenFillData, text = "Tanggal Check In", font = ("Helvetica", 15, "bold"), bg="white").place(x = 380, y = 330)
        ...
        Label(screenFillData, text = "Tanggal Check Out", font = ("Helvetica", 15, "bold"), bg="white").place(x = 780, y = 330)
        ...
        Button(screenFillData, text = "Berikutnya", font = ("Helvetica", 15, "bold"), bg="#71BC68", width = 10, height = 1, command = bukaKonfirmasiCheckIn2).place(x = 670, y = 600)
    ...
    def konfirmasiCheckIn2(self, screenFillData):
        ...
        def backToShowBook():
            self.checkInWalkIn(screenKonfirmasi2)

        Label(screenKonfirmasi2, text = "Lanjutkan Check In?", font = ("Helvetica", 12, "bold"), bg= "#F7F0F5").place(x = 635, y = 220,anchor="center")

        # Button
        Button(screenKonfirmasi2, text = "Ya", font = ("Helvetica", 12, "bold"), bg= "#DECBB7", width=10, height=1, command= self.prosesCheckInWalk).place(x = 785, y = 290, anchor="ne")
        Button(screenKonfirmasi2, text = "Tidak", font = ("Helvetica", 12, "bold"), bg= "#FF595E", width=10, height=1, command=backToShowBook).place(x = 485, y = 290, anchor="ne")
    ...
    def checkInWalkInBerhasil(self, screenWalkInValid):
        ...
        # Button
        Button(screenWalkInBerhasil, text = "Selesai Check In", font = ("Helvetica", 12, "bold"), bg= "#DECBB7", width=10, height=1, command=backToHomescreen).place(x = 785, y = 320, anchor="ne")
